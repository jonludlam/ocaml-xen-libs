(* OASIS_START *)
(* DO NOT EDIT (digest: 75cec65dcef43f0fd7d3d7731c2db835) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("xenmmap", ["lib/xenmmap"]);
          ("xeneventchn", ["lib/xeneventchn"]);
          ("xenctrl", ["lib/xenctrl"])
       ];
     lib_c =
       [
          ("xenmmap", "lib/xenmmap", ["lib/xenmmap/mmap_stubs.h"]);
          ("xeneventchn", "lib/xeneventchn", []);
          ("xenctrl", "lib/xenctrl", ["lib/xenctrl/mmap_stubs.h"])
       ];
     flags =
       [
          (["oasis_library_xeneventchn_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lxenctrl"])]);
          (["oasis_library_xeneventchn_cclib"; "ocamlmklib"; "c"],
