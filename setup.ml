...
(* OASIS_START *)
(* DO NOT EDIT (digest: 98bb3e7202fc477df1508bb3ca1ce5d7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["xenmmap_stubs.c"; "mmap_stubs.h"];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/xeneventchn";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["xeneventchn_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib/xenctrl";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xenmmap"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["xenctrl_stubs.c"; "mmap_stubs.h"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\248\255\n\028\164\196?]\0222\136\028\024\201^\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
